...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onNewIntent(Intent intent){
        ...
        NdefMessage message = getNdelMessage(str);
        write(message,tagFromintent);
    }
    @TargetApi(Build.VERSION_CODES.JELLY_BEAN)
    NdefMessage getNdelMessage(String text) {
        byte[] textBytes = text.getBytes();
        NdefRecord textRcord = new NdefRecord(NdefRecord.TNF_MIME_MEDIA, "text/plain".getBytes(), new byte[]{}, textBytes);
